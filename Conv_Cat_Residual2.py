...
from ReNetutility import Conv_Cat_Residual2
...
resnet = Conv_Cat_Residual2(input_channel = 1, layers = [1,1,1], regression_out = 1)
count = count_parameters(resnet)
#summary(resnet, float(random.randint(1,5000)), float(random.randint(1,5000)))
...
savemat("/home/jackplus2/project-seong/paper_AEVB_5000_2.mat", {'Pred':y_pred, 'True':y_true})
