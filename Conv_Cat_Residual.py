...
from ReNetutility import Conv_Cat_Residual
...
resnet = Conv_Cat_Residual(input_channel = 1, layers = [1,1,1], regression_out = 1)
...
#savemat("/home/zhuochengjiang/project-seong/Conv_Cat_Residual_50000.mat", {'Pred':y_pred, 'True':y_true})
